            ...
            <table class="table" id="table1">
                ...
                <tbody>
                    ...
                    <td>' . $row[4] . '</td> <td>';
                        ...
                        echo "<button class=\"btn btn-primary\" type=\"submit\" onclick=\"contact('$row[1]')\">賣家資訊</button>";
                        if ($row[4] == "shipping") {
                            echo "<button class=\"btn btn-warning btn-sm\" type=\"submit\" onclick=\"finishOrder('$row[0]')\">已收到</button>";
                        }
                        echo'</td></tr>';
                    }
                    if (mysql_errno() != 0) {
        ...
        <script>
            ...
            function finishOrder(order_id) {
                ...
                function(data) {
                    console.log(data);
                    if (data == 'success') {
                        $.get('bought.php').success(function(data) {
                            $('#goodframe').html(data);
                        });
                    }
                });
